...
namespace layer_1
{
    public class z_crypto
    {
        ...
        public static m_keys1 create_symmetrical_keys()
        {
            byte[] key32 = new byte[32];
            byte[] iv16 = new byte[16];
            random.NextBytes(key32);
            random.NextBytes(iv16);
            return new m_keys1() { key32 = key32, iv16 = iv16 };
        }
        ...
        public static byte[] Encrypt(byte[] data, m_keys1 keys)
        {
        ...
        public static byte[] Decrypt(byte[] data, m_keys1 keys)
        {
            MemoryStream memoryStream;
            CryptoStream cryptoStream;
            Rijndael rijndael = Rijndael.Create();
